...
real cortical column considerations to interpret spatial distribution of the blackboard in the cortex.

Physical translation of firing rates to LFP and BOLD responses, which also have to follow some relationship with each other according to the literature.

grammatical category groups and grammar theories expansion of the connection matrices, test the grammar theories and parsing scheme combinations simultaneously, no other way around for the moment.

integrate evidence of different neuroimaging measurements together, multi spatio temporal evidence scales.

Create benchmark database of experimental measurements to evaluate directly against them the different hypothesis.
...
Explore the hypothesis space through the simulation to identify conditions that maximize our exploration of linguistic theory against neuroimaging measurements.
...
Proposal of experiments in ecog patients. language FMRI localizers and adapted 3d printed frames of ecog electrodes alongside the necessary manual test of epilepsy could greatly accelerate testing hypothesis and joining evidence. Case of Amuntz language localizer variability and the importance of subject specific characterization of the language network.
