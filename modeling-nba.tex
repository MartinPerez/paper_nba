...
\noteMP{I find your modification better, what about we keep the final version as following then? I kept your changes and modified a couple words.}.

Here we demonstrate that a NBA implementation, only tuned to operational constraints, naturally reproduces the essence of two prominent language neuroimaging experiments related to binding at  different spatio-temporal scales.
We show that the model replicates aspects of  recent work from Nelson et al. \cite{Nelson_2017} based on intracortical recordings (ECoG),  which reveal temporally detailed neural patterns of word binding operations.
Moreover, we reproduce a sublinear increase of the amplitude of peak hemodynamic responses and explain peak onset differences. As reported for brain language regions, as a function of constituent size in lists of phrases, in an fMRI experiment by Pallier et al. \cite{Pallier_2011}
