...
All conditions then correspond to a divisor of 12\noteP{Too abstract for me} that determine the number of words (constituents) of each phrase, going from a list of unrelated to words to a complete phrase of 12 words.
