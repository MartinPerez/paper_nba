...
\notenewMdK{I think your answer to Chris' comment should be in here. The argument should be: there are a large number of language models that have been biologically
motivated (cite the whole bubs here), but they do not compete with the NBA in the way tensor products do. What do you mean? Are these models not combinatorial? Then say so.
The point, I think should be that from the two models on the market (because they address 'combinatorial productivity'?) tensor products and NBA, only the NBA proposes a detailed
...
\notenewMdK{Why 'van der Velde et al' and later 'van der Velde and de Kamps'. Would say one or the other, where et al is usually reserved for three or more authors}
