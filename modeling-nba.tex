...
\subsection{Reproduction of neuroimaging measurements}

{\label{729344}}

/////////////////////////////

Comment on the neuroimaging evidence and design

Comment on the fact that we will show that the NBA architecture can reproduce qualitatively the properties of the mentioned experiments after being set up just for correct operation, without being tuned to the patterns.


We provide a biologically plausible neural implementation of variable binding and
...
thought in humans\noteCP{I find this passage a bit odd, as it seems to
  ...
  you clarify?}.\noteMP{This is based on the sub problems enumeration of Feldman 2012. He basically considers that variable binding is only applicable to high level language. I have clarified his view more in the sub problems enumeration}
